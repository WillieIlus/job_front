      ...
      <div class="container mx-auto text-center">
        <div class="flex justify-center items-center">
          ...
          <div class="flex items-center ml-4">
            <a href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer" class="text-white hover:text-gray-400 transition-colors duration-200">
              <i class="fab fa-linkedin"></i>
            </a>
            <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" class="text-white hover:text-gray-400 transition-colors duration-200 ml-2">
              <i class="fab fa-facebook"></i>
            </a>
            <a href="mailto:your-email@example.com" class="text-white hover:text-gray-400 transition-colors duration-200 ml-2">
              <i class="fas fa-envelope"></i>
            </a>
            <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" class="text-white hover:text-gray-400 transition-colors duration-200 ml-2">
              <i class="fab fa-instagram"></i>
            </a>
            <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer" class="text-white hover:text-gray-400 transition-colors duration-200 ml-2">
