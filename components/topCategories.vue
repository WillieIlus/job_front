<template>
  <section v-if="categories" class="py-20 dark:bg-neutral-800">
    <div class="container mx-auto">
      ...
      <div class="grid grid-cols-12 gap-5">
        <div v-for="(category, index) in categories" :key="category.id" class="col-span-12 md:col-span-6 lg:col-span-3">
          <div class="mt-4">
