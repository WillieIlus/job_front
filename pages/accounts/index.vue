          ...
          <div class="grid grid-cols-12 gap-y-10 lg:gap-10">
            ...
            <div class="col-span-12 lg:col-span-8">
              <div class="border rounded border-gray-100/50 dark:border-neutral-600 nav-tabs bottom-border-tab">
                ...
                <!-- let's display user joblist and company list from components  -->
                <div class="space-y-8 mt-14">
                  <h5 class="text-lg font-bold text-gray-900 dark:text-gray-50">Job List</h5>

                  <JobList v-if="paginatedJobs" :jobs="paginatedJobs" :loading="loading" :error="error" />
                </div>
                <div class="space-y-8 mt-14">
                  <h5 class="text-lg font-bold text-gray-900 dark:text-gray-50">Company List</h5>
                  <FilterCompanies v-if="companies" :companies="companies" :loading="loading"
                    :error="error" />
                </div>
              </div>
            </div>
