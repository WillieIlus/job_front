                ...
                <div class="page-next">
                  <nav class="inline-block" aria-label="breadcrumb text-center">
                    <ol class="flex flex-wrap justify-center text-sm font-medium uppercase">
                      ...
                      <li><i class="bx bxs-chevron-right align-middle px-2.5"></i><a href="javascript:void(0)">Profile</a>
                      </li>
                      <li class="active" aria-current="page"><i
                          class="bx bxs-chevron-right align-middle px-2.5"></i>Manage Jobs</li>
                    </ol>
                  </nav>
                </div>
              </div>
            ...
            <div class="grid grid-cols-1 gap-y-5">
                ...
                <div class="grid grid-cols-12">
                  ...
                  <div class="col-span-12 lg:col-span-9">
                    <div class="mt-4 lg:mt-0">
                      <h5 class="mb-1 text-17"><a href="job-details.html" class="text-gray-900 dark:text-gray-50">Business
                          Associate</a></h5>
                      ...
                      <div class="flex flex-wrap gap-2 mt-3">
                        <span class="px-2 py-0.5 mt-1 font-medium text-red-500 rounded bg-red-500/20 text-13">Part
                          Time</span>
                        <span
                          class="px-2 py-0.5 mt-1 font-medium text-yellow-500 rounded bg-yellow-500/20 text-13">Urgent</span>
                      </div>
                    </div>
                  </div><!--end col-->
              ...
              <div
                ...
                <div class="grid grid-cols-12">
                  ...
                  <div class="col-span-12 lg:col-span-9">
                    <div class="mt-4 lg:mt-0">
                      <h5 class="mb-1 text-17"><a href="job-details.html"
                          class="text-gray-900 dark:text-gray-50">Marketing Director</a> <small
                      ...
                      <ul class="flex gap-3 mb-0">
                        ...
                        <li class="">
                          <p class="mb-0 text-sm text-gray-500 dark:text-gray-300"><i class="mdi mdi-map-marker"></i> New
                            York</p>
                        </li>
                        <li class="">
                          <p class="mb-0 text-sm text-gray-500 dark:text-gray-300"><i class="uil uil-wallet"></i> $250 -
                      ...
                      <div class="flex flex-wrap gap-2 mt-3">
                        <span class="px-2 py-0.5 mt-1 font-medium text-red-500 rounded bg-red-500/20 text-13">Part
                          Time</span>
                        <span
                          class="px-2 py-0.5 mt-1 font-medium text-sky-500 rounded bg-sky-500/20 text-13">Private</span>
                      </div>
                    </div>
                  </div><!--end col-->
                  <div class="items-center col-span-12 lg:col-span-2">
              ...
              <div
                ...
                <div class="grid grid-cols-12">
                  ...
                  <div class="col-span-12 lg:col-span-9">
                    <div class="mt-4 lg:mt-0">
                      <h5 class="mb-1 text-17"><a href="job-details.html" class="text-gray-900 dark:text-gray-50">HTML
                          Developer</a> <small class="font-normal text-gray-500">(2-4 Yrs Exp.)</small></h5>
                      <ul class="flex gap-3 mb-0">
                        <li class="">
                          <p class="mb-0 text-sm text-gray-500 dark:text-gray-300">Jobcy Technology Pvt.Ltd</p>
                        </li>
                      ...
                      <div class="flex flex-wrap gap-2 mt-3">
                        <span
                          class="px-2 py-0.5 mt-1 font-medium text-violet-500 rounded bg-violet-500/20 text-13">Freelance</span>
                        <span
                          class="px-2 py-0.5 mt-1 font-medium text-violet-500 rounded bg-violet-500/20 text-13">Freelance</span>
                      </div>
                    </div>
              ...
              <div
                ...
                <div class="grid grid-cols-12">
                  ...
                  <div class="col-span-12 lg:col-span-9">
                    <div class="mt-4 lg:mt-0">
                      <h5 class="mb-1 text-17"><a href="job-details.html" class="text-gray-900 dark:text-gray-50">HTML
                          Developer</a> <small class="font-normal text-gray-500">(5+ Yrs Exp.)</small></h5>
                      <ul class="flex gap-3 mb-0">
                        <li class="">
                          <p class="mb-0 text-sm text-gray-500 dark:text-gray-300">Jobcy Technology Pvt.Ltd</p>
                        </li>
                      ...
                      <div class="flex flex-wrap gap-2 mt-3">
                        <span class="px-2 py-0.5 mt-1 font-medium text-green-500 rounded bg-green-500/20 text-13">Full
                          Time</span>
                        <span
                          class="px-2 py-0.5 mt-1 font-medium text-sky-500 rounded bg-sky-500/20 text-13">Private</span>
                      </div>
              ...
              <div
                ...
                <div class="grid grid-cols-12">
                  ...
                  <div class="col-span-12 lg:col-span-9">
                    <div class="mt-4 lg:mt-0">
                      <h5 class="mb-1 text-17"><a href="job-details.html" class="text-gray-900 dark:text-gray-50">Product
                          Designer </a> <small class="font-normal text-gray-500">(0-5 Yrs Exp.)</small></h5>
                      <ul class="flex gap-3 mb-0">
                        <li class="">
                          <p class="mb-0 text-sm text-gray-500 dark:text-gray-300">Creative Agency </p>
                        </li>
                      ...
                      <div class="flex flex-wrap gap-2 mt-3">
                        <span
                          class="px-2 py-0.5 mt-1 font-medium text-blue-500 rounded bg-blue-500/20 text-13">Internship</span>
                      </div>
                    </div>
                  </div><!--end col-->
                  <div class="items-center col-span-12 lg:col-span-2">
              ...
              <div
                ...
                <div class="grid grid-cols-12">
                  ...
                  <div class="col-span-12 lg:col-span-9">
                    <div class="mt-4 lg:mt-0">
                      <h5 class="mb-1 text-17"><a href="job-details.html" class="text-gray-900 dark:text-gray-50">Project
                          Manager </a> <small class="font-normal text-gray-500">(0-2 Yrs Exp.)</small></h5>
                      <ul class="flex gap-3 mb-0">
                        <li class="">
                          <p class="mb-0 text-sm text-gray-500 dark:text-gray-300">Jobcy Technology Pvt.Ltd </p>
                        </li>
