              ...
              <div class="col-span-12 lg:col-span-8">
                <div class="border rounded-md border-gray-100/30 dark:border-neutral-600/80">
                  <div class="relative">
                    ...
                    <img :src="job.image" alt="" class="rounded-md img-fluid mb-7 object-cover">
                    ...
                    <div class="grid grid-cols-12 mt-8 gap-y-3 lg:gap-3">
                      <div class="col-span-12 lg:col-span-3">
                        <div class="p-4 border rounded border-gray-100/50 dark:border-neutral-600/80">
                          ...
                          <p class="font-medium text-gray-900 dark:text-gray-50">Minimum {{ job.work_experience }} Year
                          </p>
                        </div>
                      </div>
                      <div class="col-span-12 lg:col-span-3">
                        <div class="p-4 border rounded border-gray-100/50 dark:border-neutral-600/80">
                          ...
                          <p class="font-medium text-gray-900 dark:text-gray-50">{{ job.work_type }}</p>
                        </div>
                      </div>
                      <div class="col-span-12 lg:col-span-3">
                        <div class="p-4 border rounded border-gray-100/50 dark:border-neutral-600/80">
                ...
                <div class="border rounded border-gray-100/30 dark:border-neutral-600/80">
                  <div class="p-6">
                      ...
                      <li>
                        <div class="flex mt-6">
                          ...
                          <div class="ltr:ml-4 rtl:mr-4">
                            ...
                            <p class="text-gray-500 dark:text-gray-300"> {{ job.salary !== null ? job.currency : '' }} {{
                              job.salary }} / {{ job.salary_type }}</p>
                          </div>
                        </div>
                      </li>
                      <li>
                      ...
                      <li>
                        <div class="flex mt-6">
                          ...
                          <div class="ltr:ml-4 rtl:mr-4">
                            ...
                            <p class="text-gray-500 dark:text-gray-300">{{ job.time_since }}</p>
                          </div>
                        </div>
                      </li>
                    </ul>
                    ...
                    <div class="mt-8 space-y-2">
                      <NuxtLink v-if="job.company" :to="'mailto:' + job.email"
